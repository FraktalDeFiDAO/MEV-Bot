...
library ArbitrageLib {
    ...
    function getProfit(uint256 amountIn, uint256 rA0, uint256 rB0, uint256 rA1, uint256 rB1)
        internal
        pure
        returns (uint256)
    {
    ...
    function findBestInput(uint256 rA0, uint256 rB0, uint256 rA1, uint256 rB1, uint256 maxIn, uint256 step)
        internal
        pure
...
contract ArbitrageCalculator {
    function findOptimal(uint256 rA0, uint256 rB0, uint256 rA1, uint256 rB1, uint256 maxIn, uint256 step)
        external
        pure
        returns (uint256 bestIn, uint256 bestProfit)
    {
